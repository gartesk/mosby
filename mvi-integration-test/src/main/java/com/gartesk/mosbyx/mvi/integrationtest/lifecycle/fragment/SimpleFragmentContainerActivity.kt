...
class SimpleFragmentContainerActivity : AppCompatActivity() {
	...
	val fragment: SimpleMviLifecycleFragment
		get() = supportFragmentManager.findFragmentByTag(TAG) as SimpleMviLifecycleFragment
