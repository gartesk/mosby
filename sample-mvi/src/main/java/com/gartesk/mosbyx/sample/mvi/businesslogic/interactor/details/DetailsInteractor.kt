 ...
 */
package com.gartesk.mosbyx.sample.mvi.businesslogic.interactor.details
...
import com.gartesk.mosbyx.sample.mvi.businesslogic.model.ProductDetail
...
class DetailsInteractor(
	...
	fun getDetails(productId: Int): Observable<ProductDetailsViewState> =
		getProductWithShoppingCartInfo(productId)
			...
			.map<ProductDetailsViewState> { ProductDetailsViewState.DataState(it) }
