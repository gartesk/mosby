 ...
 */
package com.gartesk.mosbyx.mvi.sample.view.shoppingcartoverview
...
import com.gartesk.mosbyx.mvi.sample.view.detail.ProductDetailsActivity
import com.gartesk.mosbyx.mvi.sample.view.shoppingcartoverview.ShoppingCartItemViewHolder.ItemSelectedListener
...
class ShoppingCartOverviewAdapter(private val activity: Activity) :
	...
	override fun onCreateViewHolder(
		...
		ShoppingCartItemViewHolder.create(
			layoutInflater,
			this
		)
