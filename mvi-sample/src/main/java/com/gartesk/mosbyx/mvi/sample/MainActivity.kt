 ...
 */
package com.gartesk.mosbyx.mvi.sample
...
import com.gartesk.mosbyx.mvi.sample.view.home.HomeFragment
import com.gartesk.mosbyx.mvi.sample.view.menu.MenuViewState
import com.gartesk.mosbyx.mvi.sample.view.product.category.CategoryFragment
import com.gartesk.mosbyx.mvi.sample.view.product.search.SearchFragment
import com.gartesk.mosbyx.mvi.sample.view.selectedcounttoolbar.SelectedCountToolbar
...
class MainActivity : AppCompatActivity() {
	...
	override fun onCreate(savedInstanceState: Bundle?) {
		...
		val dependencyInjection =
			SampleApplication.getDependencyInjection(
				this
			)
	...
	override fun onBackPressed() {
		val selectedCountToolbar = findViewById<SelectedCountToolbar>(
			R.id.selectedCountToolbar
		)
