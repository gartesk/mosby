...
class HomePresenterTest {
	...
	fun loadingFirstPage() {
		...
		val presenter = DependencyInjection()
			.newHomePresenter()
		val robot =
			HomeViewRobot(presenter)
		...
		val loadingFirstPage =
			HomeViewState(
				loadingFirstPage = true
			)
		val firstPage =
			HomeViewState(data = expectedData)
	...
	fun loadingFirstPageAndNextPage() {
		...
		val firstPage =
			HomeViewState(data = expectedDataAfterFirstPage)
		...
		val nextPage =
			HomeViewState(data = expectedDataAfterNextPage)
	...
	fun loadingFirstPageAndNextPageAndPullToRefresh() {
		...
		val pullToRefreshLoading =
			HomeViewState(
				data = expectedDataAfterNextPage,
				loadingPullToRefresh = true
			)
		val pullToRefreshPage =
			HomeViewState(data = expectedDataAfterPullToRefresh)
	...
	fun loadingFirstPageAndMoreOfCategory() {
		...
		val loadingMoreOfCategory =
			HomeViewState(data = expectedDataWhileLoadingMoreOfCategory)
		val moreOfCategoryLoaded =
			HomeViewState(data = expectedDataAfterAllOfCategoryCompleted)
	...
	fun loadingFirstPageAndMoreOfCategoryFails() {
		...
		val loadingMoreOfCategory =
			HomeViewState(data = expectedDataWhileLoadingMoreOfCategory)
		val moreOfCategoryError =
			HomeViewState(data = expectedDataAfterLoadingMoreOfCategoryError)
